...
class FoldInitializerAndIfToElvisInspection : AbstractApplicabilityBasedInspection<KtIfExpression>(KtIfExpression::class.java) {
    ...
    override fun inspectionRange(element: KtIfExpression): TextRange? {
        val rightOffset = element.rightParenthesis?.endOffset ?: return null
        return TextRange(0, rightOffset - element.startOffset)
    }

    override fun isApplicable(element: KtIfExpression): Boolean = applicabilityRange(element) != null
